...
$this->installer1 = new TempFile("{$this->phppath}apps/plugins/forms/installer.php",false,null,$this);
$this->config1 = new TempFile("{$this->phppath}apps/plugins/forms/config.php",false,null,$this);
$this->prop1 = new TempFile("{$this->phppath}apps/plugins/forms/view_plugin.php",false,null,$this);
