...
class MdbFooter extends Control {
    public function onrender() {
        $this->tagName = 'footer';
        if(! $this->element->hasAttribute("class")) $this->setAttribute("class", "text-center text-lg-start bg-light text-muted");
        if($this->getInnerHTML() == "") {
            $this->setInnerHTML('<hr class="hr">
<div class="container">
