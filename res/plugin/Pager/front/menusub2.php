...
<menu id="pager3" runat="server" caption="<?php print $sqlCat3->getField('aname'); ?>" href="#" funsetSub="">
...
<menuitem id="menuipag1" runat="server" href="<?php print getEventPath($sql13->getField('pagename'),'','page') ; ?>" ><?php print $sql13->getField('menuname'); ?></menuitem>
  </div>
</menu>
</div>
